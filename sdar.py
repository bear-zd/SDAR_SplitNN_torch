...
class SDARAttacker:
    ...
    def d_train_step(self, xs, ys, y, z):
        ...
        return d_mse_loss.item(), d_loss.item(), d_gen_loss.item(), float(d_dis_real_loss), float(d_dis_fake_loss), float(d_dis_loss)
    ...
    def attack(self, x, y):
        ...
        return x_recon,  torch.mean(torch.square(x - x_recon))
